...
if (error) { const message = error === 'missing_config' ? 'Configura DISCORD_CLIENT_SECRET en .env para iniciar sesión.' : 'No se pudo conectar con Discord. Revisa la configuración OAuth.'; const errorElement = document.querySelector('[data-auth-error]'); if (errorElement) { errorElement.textContent = message; errorElement.classList.remove('hidden'); } }
